...
const AdminPrescriptionDetails = () => {
  ...
  if (loading) {
    return (
      <div className="admin-prescription-details">
        <header className="admin-prescription-details-header">
          <div className="admin-details-header-content">
            <div className="admin-details-logo">
              <h1>HealthEase</h1>
              <span className="admin-details-logo-subtitle">Admin Portal</span>
            </div>
            <button className="admin-details-logout-btn" onClick={handleLogout}>
              Logout
            </button>
          </div>
        </header>
        <div className="admin-details-loading-container">
  ...
  if (message) {
    return (
      <div className="admin-prescription-details">
        <header className="admin-prescription-details-header">
          <div className="admin-details-header-content">
            ...
            <div className="admin-details-header-actions">
              ...
              <button
                className="admin-details-logout-btn"
        ...
        <main className="admin-prescription-details-main">
          <div className="admin-details-message error">{message}</div>
        </main>
      </div>
    );
  }
  ...
  if (!data || !data.prescription) {
    return (
      <div className="admin-prescription-details">
        ...
        <main className="admin-prescription-details-main">
          <div className="admin-details-message error">
  ...
  return (
    <div className="admin-prescription-details">
      ...
      <main className="admin-prescription-details-main">
        ...
        <div className="admin-prescription-content">
          {/* Basic Information */}
          <div className="admin-prescription-info">
            <div className="admin-info-grid">
              <div className="admin-info-item">
                <div className="admin-info-label">Doctor</div>
                <div className="admin-info-value">{prescription.name}</div>
              </div>
              <div className="admin-info-item">
                <div className="admin-info-label">Consultation ID</div>
                <div className="admin-info-value">#{id}</div>
              </div>
              <div className="admin-info-item">
                <div className="admin-info-label">Symptoms</div>
                <div className="admin-info-value">{prescription.symptoms}</div>
              </div>
              <div className="admin-info-item">
                <div className="admin-info-label">Doctor Comments</div>
                <div className="admin-info-value">{prescription.comments}</div>
              </div>
              <div className="admin-info-item">
                <div className="admin-info-label">Appointment Details</div>
                <div className="admin-info-value">{prescription.details}</div>
              </div>
            </div>
          </div>
          ...
          <div className="admin-details-section">
            <div className="admin-section-header">
              ...
              <h3 className="admin-section-title">Prescribed Medicines</h3>
            </div>

            {medicines && medicines.length > 0 ? (
              <div className="admin-medicines-grid">
                {medicines.map((med, index) => (
                  <div key={index} className="admin-medicine-card">
                    <div className="admin-medicine-name">{med.name}</div>
                    <div className="admin-medicine-details">
                      <div className="admin-medicine-detail">
                        <span className="admin-detail-label">Dosage:</span>
                        <span className="admin-detail-value">{med.dosage}</span>
                      </div>
                      <div className="admin-medicine-detail">
              ...
              <div className="admin-empty-state">
                ...
                <div className="admin-empty-title">No Medicines Prescribed</div>
          ...
          <div className="admin-details-section">
            <div className="admin-section-header">
              <span className="admin-section-icon">🔬</span>
              <h3 className="admin-section-title">Recommended Tests</h3>
            </div>

            {tests && tests.length > 0 ? (
              <div className="admin-tests-grid">
                {tests.map((test, index) => (
                  <div key={index} className="admin-test-card">
                    <div className="admin-test-name">{test.test_name}</div>
                    <div
                      className={`admin-test-result ${
                        test.test_result && test.test_result !== "Pending"
                          ? "completed"
                          : "pending"
                      }`}
                    ...
                    <div className="admin-test-comments">
                      {test.comments || "No additional comments"}
                    </div>
                  </div>
                ))}
              ...
              <div className="admin-empty-state">
                <div className="admin-empty-icon">🔬</div>
                <div className="admin-empty-title">No Tests Recommended</div>
                <p className="admin-empty-description">
                  No laboratory tests have been recommended for this
                  consultation.
                </p>
